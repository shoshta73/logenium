...
from .commands import build, check_license_headers, clean, codegen, configure, docs, format, lint, python, setup
...
app.add_typer(docs, name="docs", help="Documentation commands")
